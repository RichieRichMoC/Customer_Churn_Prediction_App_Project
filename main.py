...
if authentication_status == True:
    ...
    def main():
        ...
        st.markdown("[![GitHub](https://img.shields.io/badge/GitHub-View%20on%20GitHub-blue?logo=GitHub)](https://github.com/RichieRichMoC/Customer_Churn_Prediction_App_Project)")
